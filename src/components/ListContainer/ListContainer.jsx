...
import {deleteItemFromSavedList, deleteList, editItemInSavedList} from "../../redux/mainPageReducer";
...
const ListContainer = (props) => {
	...
	return (
		<div>
			...
			<TableComponent shoppingList={items}
							item={list}
							editContent={props.editItemInSavedList}
							deleteProduct={props.deleteItemFromSavedList}/>
			<Button onClick={deleteListAction} type="primary" className={styles.DeleteBtn}>Удалить
				список</Button>
		</div>
	)
}
...
export default connect(mapStateToProps, {deleteItemFromSavedList, editItemInSavedList, deleteList})(ListContainer);
